...
declare module 'vscode' {
  ...
  export interface TestRun {
    /**
     * Test coverage provider for this result.
     * 此结果的测试覆盖率提供程序。
     *
     * An extension can defer setting this until after a run is complete and coverage is available.
     * 扩展可以将此设置推迟到运行完成且覆盖范围可用之后。
     */
